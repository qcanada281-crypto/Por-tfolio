(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 19559, (t, e, i) => {
    e.exports = t.r(90004)
}
, 64831, t => {
    "use strict";
    ...
    function r() {
        return "development" === ((o() ? window.vam : n()) || "production")
    }
    function l(t) {
    ...
    function a(t) {
        ...
        i.useEffect)( () => {
            !function(t={
                ...
                t.beforeSend && (null == (e = window.va) || e.call(window, "beforeSend", t.beforeSend));
                if (typeof window !== "undefined" && (window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1" || window.location.protocol === "file:")) return;
                let i = t.scriptSrc ? t.scriptSrc : r() ? "https://va.vercel-scripts.com/v1/script.debug.js" : t.basePath ? `${t.basePath}/insights/script.js` : "/_vercel/insights/script.js";
                if (document.head.querySelector(`script[src*="${i}"]`))
                    return;
                let s = document.createElement("script");
                s.src = i,
                s.defer = !0,
                s.dataset.sdkn = "@vercel/analytics" + (t.framework ? `/${t.framework}` : ""),
                s.dataset.sdkv = "1.6.1",
                t.disableAutoTrack && (s.dataset.disableAutoTrack = "1"),
                t.endpoint ? s.dataset.endpoint = t.endpoint : t.basePath && (s.dataset.endpoint = `${t.basePath}/insights`),
                t.dsn && (s.dataset.dsn = t.dsn),
                s.onerror = () => {
                    let t = r() ? "Please check if any ad blockers are enabled and try again." : "Be sure to enable Web Analytics for your project and deploy again. See https://vercel.com/docs/analytics/quickstart for more information.";
                    console.log(`[Vercel Web Analytics] Failed to load script from ${i}. ${t}`)
                }
                ,
                r() && !1 === t.debug && (s.dataset.debug = "false"),
                document.head.appendChild(s)
            }({
                framework: t.framework || "react",
                basePath: t.basePath ?? function() {
                    if (void 0 !== e.default && void 0 !== e.default.env)
                        return e.default.env.REACT_APP_VERCEL_OBSERVABILITY_BASEPATH
                }(),
                ...void 0 !== t.route && {
                    disableAutoTrack: !0
                },
        ...
        (0,
        i.useEffect)( () => {
            t.route && t.path && function({route: t, path: e}) {
                var i;
                null == (i = window.va) || i.call(window, "pageview", {
                    route: t,
                    path: e
                })
            }({
    ...
    function h(t) {
        ...
        o ? {
            ...
            }(r, Object.keys(o).length ? o : Object.fromEntries(n.entries())),
            path: r
        } : {
            route: null,
            path: r
        ...
        return i.default.createElement(a, {
            ...
            basePath: function() {
                if (void 0 !== e.default && void 0 !== e.default.env)
                    return e.default.env.NEXT_PUBLIC_VERCEL_OBSERVABILITY_BASEPATH
            }(),
            framework: "next"
        })
    }
...
, 7482, t => {
    ...
    var o = class {
      ...
      , d = class {
        ...
        dimensions;
        virtualScroll;
        constructor({wrapper: t=window, content: e=document.documentElement, eventsTarget: i=t, smoothWheel: s=!0, syncTouch: o=!1, syncTouchLerp: r=.075, touchInertiaExponent: l=1.7, duration: a, easing: d, lerp: p=.1, infinite: u=!1, orientation: m="vertical", gestureOrientation: f="horizontal" === m ? "both" : "vertical", touchMultiplier: v=1, wheelMultiplier: w=1, autoResize: S=!0, prevent: g, virtualScroll: y, overscroll: b=!0, autoRaf: E=!1, anchors: T=!1, autoToggle: x=!1, allowNestedScroll: z=!1, __experimental__naiveDimensions: N=!1, naiveDimensions: L=N, stopInertiaOnNavigate: R=!1}={}) {
            window.lenisVersion = "1.3.17",
            t && t !== document.documentElement || (t = window),
            "number" == typeof a && "function" != typeof d ? d = c : "function" == typeof d && "number" != typeof a && (a = 1),
            this.options = {
                wrapper: t,
                content: e,
                eventsTarget: i,
        ...
        onClick = t => {
            let e = t.composedPath().filter(t => t instanceof HTMLAnchorElement && t.getAttribute("href"));
            ...
            this.options.stopInertiaOnNavigate && e.find(t => t.host === window.location.host) && this.reset()
        }
        ;
        onPointerDown = t => {
        ...
        onVirtualScroll = t => {
            ...
            if (a.find(t => t instanceof HTMLElement && ("function" == typeof h && h?.(t) || t.hasAttribute?.("data-lenis-prevent") || o && t.hasAttribute?.("data-lenis-prevent-touch") || n && t.hasAttribute?.("data-lenis-prevent-wheel") || this.options.allowNestedScroll && this.checkNestedScroll(t, {
                deltaX: e,
                deltaY: i
            }))))
                return;
            ...
            let d = o && this.options.syncTouch
              , p = o && "touchend" === s.type;
            p && (c = Math.sign(this.velocity) * Math.pow(Math.abs(this.velocity), this.options.touchInertiaExponent)),
        ...
        ;
        scrollTo(t, {offset: e=0, immediate: i=!1, lock: o=!1, programmatic: n=!0, lerp: r=n ? this.options.lerp : void 0, duration: l=n ? this.options.duration : void 0, easing: a=n ? this.options.easing : void 0, onStart: h, onComplete: d, force: p=!1, userData: u}={}) {
            if (!this.isStopped && !this.isLocked || p) {
                if ("string" == typeof t && ["top", "left", "start", "#"].includes(t))
                    ...
                    let i;
                    if ("string" == typeof t ? (i = document.querySelector(t)) || ("#top" === t ? t = 0 : console.warn("Lenis: Target not found", t)) : t instanceof HTMLElement && t?.nodeType && (i = t),
                    i) {
                ...
                if ("number" == typeof t) {
                    ...
                    "number" == typeof l && "function" != typeof a ? a = c : "function" == typeof a && "number" != typeof l && (l = 1),
        ...
        checkNestedScroll(t, {deltaX: e, deltaY: i}) {
            let s, o, n, r, l, a, h, c, d, p, u, m, f, v, w = Date.now(), S = t._lenis ??= {}, g = this.options.gestureOrientation;
            if (w - (S.time ?? 0) > 2e3) {
                S.time = Date.now();
                ...
                let i = e.overflowX
                  , d = e.overflowY;
                if (s = ["auto", "overlay", "scroll"].includes(i),
                o = ["auto", "overlay", "scroll"].includes(d),
                S.hasOverflowX = s,
                S.hasOverflowY = o,
                !s && !o || "vertical" === g && !o || "horizontal" === g && !s)
                    return !1;
                l = t.scrollWidth,
                a = t.scrollHeight,
                h = t.clientWidth,
                ...
                h = S.clientWidth,
                c = S.clientHeight;
            if (!s && !o || !n && !r || "vertical" === g && (!o || !r) || "horizontal" === g && (!s || !n) || ("horizontal" === g ? d = "x" : "vertical" === g ? d = "y" : (0 !== e && s && n && (d = "x"),
            0 !== i && o && r && (d = "y")),
            !d))
                return !1;
            if ("x" === d)
    ...
    function n() {
        ...
        e.jsx)(o.AnimatePresence, {
            ...
            e.jsxs)(s.motion.div, {
                ...
                className: "fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#CFFF04] text-black",
                children: [(0,
                e.jsx)("div", {
                    ...
                    e.jsx)(s.motion.div, {
                        ...
                        className: "relative flex items-baseline text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black uppercase tracking-widest",
                        children: (0,
                        e.jsx)("span", {
                            className: "splash-brand-title text-black",
                            children: "ABDELILAH"
                        })
                    })
                }), (0,
                e.jsx)(s.motion.div, {
                    ...
                    className: "absolute bottom-12 splash-brand-sub text-xs md:text-sm font-bold tracking-[0.3em] uppercase text-black",
                    children: "ABDELILAH EL ABED"
                })]
            })
        })
    }
